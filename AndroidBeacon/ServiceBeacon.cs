...
namespace AndroidBeacon
{
	public class ServiceBeaconAdapter : FragmentStatePagerAdapter{
		...
		public void addFragmentView(Func<LayoutInflater, ViewGroup, View> view){
	...
	{
		private Func<LayoutInflater, ViewGroup, View> _view;
		/*public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			var view = inflater.Inflate (Resource.Layout.Page, container, false);
			return view;
		}*/
		public ServiceBeacon(Func<LayoutInflater, ViewGroup, View> view){
			_view = view;
		}
		public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
